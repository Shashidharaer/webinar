...
export declare type usePaginatedParticipantsInput = HMSPeerListIteratorOptions;
export declare const usePaginatedParticipants: (options: HMSPeerListIteratorOptions) => {
    loadPeers: () => Promise<void>;
    loadMorePeers: () => Promise<void>;
    hasNext: () => boolean;
    total: number;
