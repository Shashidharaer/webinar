...
import { HMSRoleChangeRequest as SDKHMSRoleChangeRequest, HMSTrack as SDKHMSTrack } from '../internal';
...
export declare class SDKToHMS {
    ...
    static convertMessage(sdkMessage: MessageNotification, localPeerId: HMSPeerID): Partial<HMSMessage> & Pick<HMSMessage, 'sender'>;
