...
export declare function makeHMSStoreHook(hmsContext: React.Context<HMSContextProviderProps | null>): <StateSlice>(selector: StateSelector<HMSStore<{
    sessionStore: Record<string, any>;
}>, StateSlice>, equalityFn?: EqualityChecker<StateSlice>) => StateSlice;
